...
These signals are known to originate from the transmembrane currents, typically described in terms of current dipoles, which are associated with cortical neural activity. 
