...
We found that for all cases the components of the current dipole moment ($\mathbf{p}$) that was orthogonal ($p_x$ and $p_y$) to the depth axis of cortex ($z$)
was negligible compared to the $p_z$-component, as expected from radial symmetry \citep{HAGEN2018}.
