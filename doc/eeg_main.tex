...
\newtxt{We here chose to focus on the scenario with transient thalamocortical input for mimicking event-related potentials (ERPs), but instead focusing on different neural oscillations (brain waves) or spontaneous activity would have served equally well for our purposes.}
