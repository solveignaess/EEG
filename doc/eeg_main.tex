...
The computed EEG signals from the two head models also gave comparable results in both spatial shape and amplitude. The relative difference between the EEG signals calculated with the four sphere model and the NYH model at the time of maximum signal amplitude was \newtxt{25.2\% and 201\%} for the positions in the occipital and parietal lobe respectively  (Fig.~\ref{fig:compare_head_models}\textbf{C-F}).
