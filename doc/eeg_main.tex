...
\newtxt{A further complication of ECoG signals is that since the electrodes are both relatively large and close to the neural current sources, the ECoG electrodes themselves might be expected to strongly impact the measured signals \citep{Ness2015, Rogers2020, Vermaas2020}.}
