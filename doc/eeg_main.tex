...
Analogous to how electric charges can create charge multipoles, a combination of current sinks and sources can set up current multipoles \citep{NUNEZ2006}. \snnote{Multipole expansion is different way of expressing equation 2.} From electrodynamics we know that extracellular potentials at a distance $R$ from the source can be precisely described by a multipole expansion
...
\paragraph{Multi-dipole approach}

\paragraph{Single-dipole approximation}

\subsection{Inhomogeneous head models}
...
\sntxt{
\begin{itemize}
	\item Segev, Hay, chandelier cell
	\item Conductance-based synapses
	\item Tables with membrane resistance/ axial resistamce/ memebrane capacitance, etc?
	\item Population activity with Hybrid scheme \cite{HAGEN2016}
\end{itemize}
}
