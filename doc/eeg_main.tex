...
The presented formalism is well suited for modeling \sntxt{\sout{studies of}} \sntxt{EEG contributions \sout{the contribution to the EEG signal}} from \sntxt{\sout{different} various} potential neural origins, \sntxt{\sout{like} including} different cell types, different ion channels, or different synaptic pathways. 
