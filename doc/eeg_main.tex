...
\subsection{Application of current dipoles \gex{for computing MEG and ECoG signals}}
...
Similarly, we can, to a high degree, explain the measurement physics of \sntxt{\sout{the}} EEG\sntxt{/MEG \sout{signal}}, that is, how neural currents affect \sntxt{\sout{electric potentials} electromagnetic brain signals} recorded outside of the head \citep{NUNEZ2006, COHEN2017}\sntxt{\citep{Ilmoniemi2019}}.
