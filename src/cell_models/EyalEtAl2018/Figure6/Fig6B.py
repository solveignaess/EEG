######
#
# This code creates Figure 6B in Eyal et al 2017
# It generates NMDA spike in 21 basal terminals of human model 130306
...
def run_exp(basal_list,apic_list,seg_to_num_of_syn,plot_ms = 10):
    nmda_tips = []
...
apic_list = []
basal_list = [6,12,14,18,22,25,32,35,40,44,46,49,54,57,61,64,65,70,73,76,78]
